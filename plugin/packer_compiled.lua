...
local package_path_str = "/root/.cache/nvim/packer_hererocks/2.1.1720049189/share/lua/5.1/?.lua;/root/.cache/nvim/packer_hererocks/2.1.1720049189/share/lua/5.1/?/init.lua;/root/.cache/nvim/packer_hererocks/2.1.1720049189/lib/luarocks/rocks-5.1/?.lua;/root/.cache/nvim/packer_hererocks/2.1.1720049189/lib/luarocks/rocks-5.1/?/init.lua"
local install_cpath_pattern = "/root/.cache/nvim/packer_hererocks/2.1.1720049189/lib/lua/5.1/?.so"
...
_G.packer_plugins = {
  catpuccin = {
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/catpuccin",
